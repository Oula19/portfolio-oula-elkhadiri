      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="animate-fade-in-up">
            <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-6">À propos de moi</h2>
          ...
          <div className="flex justify-center animate-fade-in">
            <div className="relative">
              <div className="w-full max-w-md bg-gradient-to-br from-primary to-primary-royal rounded-2xl p-6 sm:p-8 text-white">
                <h3 className="text-lg sm:text-xl font-semibold mb-4">Ma philosophie</h3>
